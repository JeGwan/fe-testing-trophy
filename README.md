...
| 3 | Test | Unit (2) + Component (3) | Vitest (+ jsdom + RTL) |
| 4 | Build | Static (1.3) | `next build` |
| 5 | Install Playwright (캐시) | E2E 준비 | `actions/cache` + `playwright install` |
| 6 | E2E | E2E (4) | Playwright + Chromium |
